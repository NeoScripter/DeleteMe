import { type BreadcrumbItem, type SharedData } from '@/lib/types';
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <SettingsLayout>
                <div className="space-y-6">
                    <HeadingSmall title="Информация пользователя" description="Изменить имя пользователя и электронную почту" />
